...
<div class="title_flex">
    ...
    <?php if($_SESSION["user"]->userPermission === "admin") :?>
        <button class="addSCP" onclick="location.href = 'scpnew'">Ajouter un SCP</button>
    ...
    <div class="scp__safe_list">
        ...
        <?php foreach($safe as $scp) :?>
            ...
            <div class="scp__card">
                ...
                <div class="scp__card_right">
                    ...
                    <p>Classe: <?= ucfirst($scp->SCPClass) ?></p>
                    <div class="scp__card_buttons">
                        <button class="card_button" onclick="location.href = 'scpView?SCPID=<?= $scp->SCPID?>'">
                            <span>Consulter</span>
                        </button>
                        <?php if(isset($_SESSION["user"])) :?>
                        <?php if($_SESSION["user"]->userPermission === "admin") :?>
                            <button class="card_delete" onclick="location.href = 'scpDelete?SCPID=<?= $scp->SCPID?>'"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                        ...
                        <button class="card_edit" onclick="location.href = 'SCPUpdate?SCPID=<?= $scp->SCPID?>'"><svg class="feather feather-edit" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button>
                        <?php endif?>
                        <?php endif?>
                        </div>
                    </div>
        ...
        <div class="scp__euclide_list scpList">
    ...
    <div class="scp__keter_list scpList">
        <h2>Keter</h2>
