...
<link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Rubik+Glitch&display=swap" rel="stylesheet">


    <div class="head">
        <div class="content">

            <img src="Img/icon.png" alt="logo SCP" class="logo">
            <h1>Fondation SCP</h1>
            
            <h2><a class="letter">S</a>ecure. <a class="letter">C</a>ontain. <a class="letter">P</a>rotect.</h2>
        </div>
        <div class="socials">
            <div class="twitter">
                <a href="https://twitter.com/scpwiki" target="_blank">
            ...
            <div class="youtube">
                <a href="https://www.youtube.com/c/ArchivesFondationSCP" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50"
                style="fill:#1A1A1A;">
            ...
            <div class="reddit">
                <a href="https://www.reddit.com/r/SCP/" target="_blank">
    ...
    <div class="main_description">
        ...
        <h2>Notre Mission</h2>
        <p>
    La mission principale de la Fondation SCP est de maintenir la normalité dans un monde où des phénomènes surnaturels menacent la sécurité et la stabilité de la société. Pour ce faire, elle opère secrètement à travers le monde, utilisant des ressources technologiques avancées, des équipes spécialisées et des installations secrètes pour contenir et étudier les SCP.</p>
</div>
...
<div class="site">
    ...
    <div class="site_header">
        ...
        <button class="addSite" onclick="location.href = 'sitenew'">Ajouter un site</button>
    ...
    <div class="card-list">
        ...
        <div class="card">
            <img class="card_img" src="Assets/Pictures/Sites/<?= $site->siteImg?>"></img>
            ...
            <div class="card_buttons">
                ...
                <?php if(isset($_SESSION["user"])) :?>
                        <?php if($_SESSION["user"]->userPermission === "admin") :?>
                            <button class="card_delete" onclick="location.href = 'siteDelete?siteID=<?= $site->siteID?>'"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
