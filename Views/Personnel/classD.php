...
<div class="guard__card_container">
    ...
    <p class="scientist__firstName">Prénom: <?= $classD->classDFirstName ?></h1>
            ...
            <?php if(isset($_SESSION["user"])) :?>
                   <?php if($_SESSION["user"]->userPermission === "admin") :?>
                        <button class="card_delete" onclick="location.href = 'classDDelete?classDID=<?= $classD->classDID?>'"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                        ...
                        <button class="card_edit" onclick="location.href = 'classDUpdate?classDID=<?= $classD->classDID?>'">
