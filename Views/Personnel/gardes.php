...
<?php if(isset($_SESSION["user"])) : ?>
    <?php if($_SESSION["user"]->userPermission === "admin") :?>
        <button class="addGuard" onclick="location.href = 'newGarde'">Ajouter un garde</button>
...
<div class="guard__card_container">
    <?php foreach($guards as $guard) :?>
        <div class="guard__card">
            ...
            <img src="Assets/Pictures/Gardes/<?=$guard->GuardImg?>" alt="" class="guard__img">
    <p class="scientist__firstName">Prénom: <?= $guard->GuardFirstName ?></h1>
            <p class="scientist__name">Nom: <?= $guard->GuardName ?></p>
            <p class="scientist__description">Description: <?= $guard->GuardDescription?></p>
            <p class="scientist__rank">Rang: <?=$guard->GuardRank?></p>
            <div class="card_buttons">
                
            <?php if(isset($_SESSION["user"])) :?>
                   <?php if($_SESSION["user"]->userPermission === "admin") :?>
                        <button class="card_delete" onclick="location.href = 'gardeDelete?guardID=<?= $guard->GuardID?>'"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                    ...
                    <button class="card_edit" onclick="location.href = 'guardUpdate?GuardID=<?= $guard->GuardID?>'"><svg class="feather feather-edit" fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button>
